# sinrules.md — cua-touch: Regeln & Verbote
...
Dieses Repo (cua-touch) ist Teil der **SIN-CLIs Stealth Suite** und MUSS:
...
Check mit: `python3 /Users/jeremy/dev/stealth-runner/scripts/check_doc_health.py --repo cua-touch`
